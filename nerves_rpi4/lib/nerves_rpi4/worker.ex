...
#  require Pwm
  ...
  def init(state = [:led]) do
    ...
    Task.async(fn -> UartMhz19.init(:sonsor_co2, "ttyAMA4") end)
#    Task.async(fn -> UartMhz19.init(:sonsor_co2, "ttyAMA0") end)
#    Task.async(fn -> UartMhz19.init(:sonsor_co2, "ttyS0") end)
